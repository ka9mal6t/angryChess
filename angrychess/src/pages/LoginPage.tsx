...
const LoginPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handlePasswordFocus = () => {
      ...
      document.querySelector('.login__img-dark')?.classList.add('in_focus');
      if (themeToggle.checked) {
        eyes.style.transform = `translateX(70%) translateY(277%) rotate(180deg)`;
      } else {
        eyes.style.transform = `translateY(51.1%) translateX(70%) rotate(-18deg)`;
      }
    };
    ...
    const handlePasswordBlur = () => {
      ...
      document.querySelector('.login__img-dark')?.classList.remove('in_focus');
      if (themeToggle.checked) {
        eyes.style.transform = `translateX(70%)`;
      } else {
        eyes.style.transform = `translateY(51.1%) translateX(70%) rotate(-18deg)`;
