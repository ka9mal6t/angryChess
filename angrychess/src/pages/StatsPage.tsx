...
import { getInfo, startSearchGame, stopSearchGame, checkStatusGame, getInfoAboutUser, getMatchesUser} from '../api/auth';
                          ...
                          <tr>
                            ...
                            <td className={match.end ? (match.winner_id ? (match.winner_id === userIdNumber ? 'win': 'loss') : 'draw'): ''}>
                              {match.end ? (match.winner_id ? (match.winner_id === userIdNumber ? 'Win': 'Lose') : 'Draw'): ''}
                                ...
                                : 
                                <Link style={{textDecoration: 'none', color: 'inherit'}} to={"/angryChess/matchOnline/" + match.id}>
